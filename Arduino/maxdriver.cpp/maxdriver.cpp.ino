...
// !!! do not regard !! set HIGHRES_MODE to true only when setting PULSE_WIDTH to MAX30102_SPC_PW_1600US_16BITS <-- pretty sure this doen't exist? must check original driver


/**
    $$$$ From the datasheet: $$$
The LED current can be programmed from 0 to 50mA with proper supply voltage. 
The LED pulse width can be programmed from 69μs to 411μs 
to allow the algorithm to optimize SpO2 and HR accuracy and power consumptionbased on use cases.
**/
